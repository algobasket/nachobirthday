...
class Tank_auth
{
	 ...
	 * @return	array
	 */
	function create_user($firstname,$lastname,$username,$email,$password,$email_activation)
	{
	...
	{
	  return $this->ci->users->get_user_by_id($user_id,$activated);
	}
	/**
	...
	{
	  return $this->ci->users->get_user_profile_detail($user_id);
	}
	...
	function get_activation_key($user_id)
	{
	 return $this->ci->users->get_activation_key($user_id);
	}
	/**
