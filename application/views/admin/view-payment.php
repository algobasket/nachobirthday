					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Payment <span class="pull-right"><a href="<?php echo base_url();?>admin_payment/view_all_payment">View All</a></span></h3>     
							</div>
							<div class="module-body">
								...
								<div class="form-horizontal row-fluid">   
                                        ...
                                        <div class="control-group">
											...
											<div class="controls"> 
												<label class="radio inline"><?php echo $payment_type;?> 
																									</label>
											</div>
										</div>  										
										<div class="control-group">
