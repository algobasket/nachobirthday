...
Your new email address on <?php echo $site_name; ?> <img src="http://nachobirthday.appstudev.com/assets/images/n.png" alt="" width="250"> 
</h2>
<h5>You have changed your email address for <?php echo $site_name; ?>.</h5><br />
<h5>Follow this link to confirm your new email address:</h5><br /> 
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;">
   <b><a href="<?php echo site_url('/reset_email/'.$user_id.'/'.$new_email_key); ?>" style="color: #3366cc;">Confirm your new email</a></b>
</big>
<br />
<br />
<h5>Link doesn't work? Copy the following link to your browser address bar:</h5><br />
<nobr><a href="<?php echo site_url('/reset_email/'.$user_id.'/'.$new_email_key); ?>" style="color: #3366cc;">
